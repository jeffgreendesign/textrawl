...
<Aside type="caution">
  Never commit your service key to version control. Use `.env` files or secret managers.
</Aside>
...
- [Quick Start](/getting-started/quick-start/) - Connect Claude Desktop
- [Security Hardening](/guides/security-hardening/) - Production security
- [Cloud Run Deployment](/guides/cloud-run-deployment/) - Deploy to GCP
