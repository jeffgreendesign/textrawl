...
- [Add your first documents](/cli/overview/) with CLI tools
- [Configure embeddings](/getting-started/configuration/) for Ollama (local)
- [Deploy to production](/guides/docker-deployment/) with Docker
