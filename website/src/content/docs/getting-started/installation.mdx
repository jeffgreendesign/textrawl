...
<TabItem label="Docker (Local Stack)">
...
- [Configuration](/getting-started/configuration/) - All environment options
- [Quick Start](/getting-started/quick-start/) - Connect to Claude Desktop
- [CLI Tools](/cli/overview/) - Import your documents
