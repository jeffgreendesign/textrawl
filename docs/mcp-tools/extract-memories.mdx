...
| `source` | enum | OPTIONAL | `document` | Source: conversation, note, document, manual |
| `storeResults` | boolean | OPTIONAL | `false` | Store extracted memories in database |
...
- `remember_fact` - Manually store individual facts
- `recall_memories` - Search extracted memories
