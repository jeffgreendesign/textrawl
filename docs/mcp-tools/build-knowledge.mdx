...
- [`recall_memories`](/docs/mcp-tools/recall-memories) - Search across stored memories
- [`get_entity_context`](/docs/mcp-tools/get-entity-context) - Get all memories and relations for an entity
