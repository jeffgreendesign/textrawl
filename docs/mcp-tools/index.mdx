...
description: Complete reference for textrawl's 25 MCP tools
---

textrawl exposes 25 tools via the Model Context Protocol (MCP). These tools allow Claude and other MCP clients to search, retrieve, create, and manage documents, memories, conversations, and insights in your knowledge base.
