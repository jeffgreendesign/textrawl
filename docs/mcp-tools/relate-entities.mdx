...
| Relation | Example |
|----------|---------|
| `works_at` | Ada works_at Acme Corp |
...
```json
{"ok":true,"rel":"550e8400","from":{"id":"550e8401","n":"Ada","t":"person"},"to":{"id":"550e8402","n":"Acme Corp","t":"organization"}}
```
...
{
  "success": true,
  "message": "Created relation: Ada works_at Acme Corp",
...
- `Ada works_at Acme` means Ada is the employee
- `Acme employs Ada` would be the inverse
