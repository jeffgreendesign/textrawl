...
```json
{"n":3,"e":[{"n":"Ada","t":"person","m":[{"c":"prefers TypeScript over JavaScript","s":0.92},{"c":"uses VS Code as primary editor","s":0.85}]},{"n":"Development Setup","t":"preference","m":[{"c":"dark mode enabled by default","s":0.78}]}]}
```
...
```json
{"n":45,"e":[{"n":"Ada","t":"person"},{"n":"Acme Corp","t":"organization"}]}
```
...
```json
{
  ...
  "offset": 0,
  "entities": [
    { "id": "550e8400-...", "name": "Ada", "type": "person", "updatedAt": "2026-01-05T10:00:00Z" },
