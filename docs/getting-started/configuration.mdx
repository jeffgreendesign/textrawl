...
| `GOOGLE_EMBEDDING_MODEL` | If Google | Model name (default: `gemini-embedding-2`) |
...
- Dimensions: 1536 (requested via outputDimensionality; the model is natively 3072d)
...
| `EXTRACTION_MODEL` | No | `claude-haiku-4-5` | Model for entity extraction |
...
| Variable | Required | Default | Description |
|----------|----------|---------|-------------|
| `INSIGHT_MODEL` | No | `claude-sonnet-5` | Model for insight synthesis |
