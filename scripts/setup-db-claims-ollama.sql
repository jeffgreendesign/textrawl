-- =============================================================================
-- Source-Backed Claims Schema (Ollama, 1024d)
-- =============================================================================
-- Run this in the Supabase SQL Editor / via psql AFTER setup-db-ollama.sql.
--
...
CREATE TABLE IF NOT EXISTS claims (
  ...
  embedding           vector(1024),               -- Ollama nomic-embed-text
