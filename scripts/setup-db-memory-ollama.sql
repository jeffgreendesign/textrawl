...
DROP FUNCTION IF EXISTS memory_semantic_search(VECTOR(1024), INT, TEXT[], BOOLEAN);
DROP FUNCTION IF EXISTS memory_hybrid_search(TEXT, VECTOR(1024), INT, FLOAT, FLOAT, INT, TEXT[], BOOLEAN);
